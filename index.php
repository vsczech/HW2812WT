...
$works = [
  [
    ...
    'description' => 'Описание тяжелой работы топ-менеджера, еще описание тяжелой работы топ-менеджера',
  ],
  ...
  [
    ...
    'EndDate' => '31.01.2022',
    'description' => 'Описание изнурительной работы менеджера среднего звена, еще описание изнурительной работы менеджера среднего звена',
  ],
  ...
  [ 
    ...
    'EndDate' => '31.01.2021',
    'description' => 'Описание трудовых обязанностей младшего научного сотрудника, еще описание трудовых обязанностей младшего научного сотрудника',
  ],
];
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($works); $i++): ?>
                <div class="w3-container"> 
                  <h5 class="w-opacity"><b><?=$works[$i]['name'];?></b></h5> 
